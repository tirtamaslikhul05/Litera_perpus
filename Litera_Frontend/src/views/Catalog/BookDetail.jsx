...
export default function BookDetail() {
  ...
  const handlePinjam = async () => {
    ...
    try {
      ...
      setToast({ 
        type: 'success', 
        message: 'Buku berhasil dipinjam! Silakan cek di Rak Buku.' 
      });
      ...
      setToast({ 
        type: 'error', 
        message: err.message || 'Gagal memproses pinjaman.' 
      });
    } finally {
      setSubmitting(false);
    }
          ...
          {isBookAvailable ? (
            <>
              ...
              >
                ...
                <span>{submitting ? 'Memproses...' : 'Konfirmasi Pinjam'}</span>
              </button>
